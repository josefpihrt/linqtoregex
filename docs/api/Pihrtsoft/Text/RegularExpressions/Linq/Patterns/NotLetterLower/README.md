...
## NotLetterLower\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_NotLetterLower"></a>
...
## NotLetterLower\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_NotLetterLower_System_Int32_"></a>
