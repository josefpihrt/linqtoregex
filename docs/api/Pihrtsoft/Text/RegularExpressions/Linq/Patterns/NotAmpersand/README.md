...
## NotAmpersand\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_NotAmpersand"></a>
...
## NotAmpersand\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_NotAmpersand_System_Int32_"></a>
