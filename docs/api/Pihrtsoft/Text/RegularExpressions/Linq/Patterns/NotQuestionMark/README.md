...
## NotQuestionMark\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_NotQuestionMark"></a>
...
## NotQuestionMark\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_NotQuestionMark_System_Int32_"></a>
