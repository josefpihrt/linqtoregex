...
## LatinLetterUpper\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_LatinLetterUpper"></a>
...
## LatinLetterUpper\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Patterns_LatinLetterUpper_System_Int32_"></a>
