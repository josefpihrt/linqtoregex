...
## DisallowGroup\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_DisallowGroup_System_Int32_"></a>
...
## DisallowGroup\(String\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_DisallowGroup_System_String_"></a>
