...
## Dollar\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_Dollar"></a>
...
## Dollar\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_Dollar_System_Int32_"></a>
