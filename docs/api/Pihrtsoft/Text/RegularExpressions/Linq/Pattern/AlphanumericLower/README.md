...
## AlphanumericLower\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_AlphanumericLower"></a>
...
## AlphanumericLower\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_AlphanumericLower_System_Int32_"></a>
