...
## NotCurlyBracket\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_NotCurlyBracket"></a>
...
## NotCurlyBracket\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_NotCurlyBracket_System_Int32_"></a>
