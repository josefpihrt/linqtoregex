...
## VerticalBar\(\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_VerticalBar"></a>
...
## VerticalBar\(Int32\) <a id="Pihrtsoft_Text_RegularExpressions_Linq_Pattern_VerticalBar_System_Int32_"></a>
